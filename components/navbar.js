...
function NavBar() {
  ...
  return (
    <div className="sticky self-start top-0 z-10">
      <div className="flex flex-col items-center py-4 px-5 bg-white z-[5] relative mwsm20:relative">
        <nav className="flex flex-row-reverse items-center w-full max-w-[1170px] mwsm20:relative">
          <div onClick={() => toogleDropDown()} className="flex justify-center items-center mt-2 ml-5 w-6 h-6 cursor-pointer sm20:hidden mwsm20:block">
            <img
          ...
          <div className="flex flex-row-reverse items-center gap-3 w-[164px] h-[45.74px] cursor-default">
          ...
          <div className="flex items-center flex-row-reverse gap-[50px] pr-[90px] mwsm20:hidden">
            <div
              className={
                useRouter.asPath === "/"
          ...
          <div className="mr-auto flex items-center flex-row-reverse gap-[35px]">
            <div>
              <img
      ...
      <div
        ...
        className="w-full h-[46px] pt-[10px] z-[1] top-[78px] absolute bg-white transition-all duration-300"
      >
        <div className="flex items-center flex-row-reverse gap-[50px] pr-[50px] top-10 right-[-20px] z-[1] mwxxsm:pr-6 mwxxsm:gap-6">
          <div
            className={
