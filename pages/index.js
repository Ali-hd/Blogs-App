...
const HomePage = () => {
  return (
    <div className="flex flex-col items-center gap-[70px]">
      ...
      <Carousel />
      <div className="w-full max-w-[1170px] flex flex-col justify-center gap-[70px]">
        <div className="flex flex-col gap-[18px] items-center">
        <div className="flex flex-row-reverse items-center gap-[10px] w-full justify-between">
            <h2 className="font-normal text-2xl leading-[30px] text-right text-[#202221] mwlg2:pr-5">{home.mostRead.header}</h2>
            <div className="flex flex-row-reverse items-center cursor-pointer mwlg2:pl-5">
          ...
          <div className="flex gap-[30px] flex-row-reverse justify-center flex-wrap">
            {home.mostRead.media.map((ele, i) => {
              return (
                <div key={i} className="w-[370px] h-[250px] relative rounded-tr-[3px] rounded-tl-[3px] mwxxsm:w-full">
                  <img className="w-full h-[250px]" src={ele.image} alt="most read" />
                  <div className="absolute bottom-5 text-white text-right px-[18px] flex flex-col gap-3">
        ...
        <div className="flex flex-row-reverse items-start p-0 gap-[30px] mwlg2:flex-col mwlg2:items-center">
        <div className="w-full max-w-[594px] flex flex-col mwlg2:max-w-[750px] mwlg2:w-full">
            ...
            <div className="flex flex-col p-[18px] gap-3 mwxsm2:gap-[9px]">
          ...
          <div className="flex flex-col min-w-[524px] gap-5 mwlg2:max-w-[770px] mwmd2:p-[10px] mwxsm2:min-w-[unset]">
            {home.firstLayout.leftSide.map((ele, i) => {
              return (
                <div key={i} className="flex flex-row-reverse items-center gap-[18px]">
                  <img className="max-w-[193px] w-full h-[160px] rounded mwxsm2:h-[124px] mwxsm2:w-[127px] mwxsm2:rounded" src={ele.image} alt="im" />
                  <div className="!p-0 flex flex-col gap-3 mwxsm2:gap-[9px]">
                    <div className="flex flex-row-reverse gap-2">
                      <div className="w-[2px] h-[19px] bg-brand"></div>
        ...
        <div className="border-2 border-solid border-[#eceeed]"></div>
        <div className="h-[358px] w-full rounded relative mwsm:h-[263px] mwsm:transition-all">
          <img className="w-full h-full object-cover" src={home.heighlight.image} alt="highlight" />
          <div className="absolute top-[82px] right-[125px] flex flex-col items-end gap-3 text-right max-w-[520px] mwsm20:right-[60px] mwsm:right-10 mwsm:top-[60px] mwsm:gap-2">
        ...
        <div className="flex flex-row-reverse gap-[30px] px-4 mwlg2:py-0 mwlg2:px-4 mwmd2:flex-col mwmd2:m-auto mwmd2:max-w-[750px]">
          <div className="flex flex-col gap-5 max-w-[270px] mwmd2:max-w-[unset]">
          ...
          <div className="layout2-left-container relative mwmd2:h-[539px]">
            ...
            <div className="flex flex-col p-[18px] gap-3 absolute bottom-6 right-[18px] mwxsm2:gap-[9px]">
              <div className="flex flex-row-reverse gap-2">
                <div className="w-[2px] h-[19px] bg-brand"></div>
